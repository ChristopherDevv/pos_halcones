                    ...
                    <div class="col-lg-6">
                        <div class="p-5">
                            <div class="text-center">
                                <h1 class="h4 text-gray-900 mb-4">Registrate aquí!</h1>
                            </div>
                            <form class="user" method="POST" action="user/validate">
                                ...
                                <div class="form-group">
                                    <input type="passwordv" class="form-control form-control-user" id="exampleInputPassword" placeholder="Confirme su password...">
                                </div>
                                <div class="form-group">
                            ...
                            <div class="text-center">
                                <a class="small" href="/">Ya tienes cuenta? Inicia sesión aquí</a>
                            </div>
                            <br>
                            <br>
                        </div>
