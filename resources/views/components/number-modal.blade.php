            ...
            <div class="modal-body">
                ...
                <form id="accept-form" action="{{ $acceptRoute }}" method="POST">
                    ...
                    <div class="form-group">
                        <label for="numberModal">{{$numberName}}</label>
                        <input class="form-control input-dark rounded-input" placeholder="Ejemplo: 300.00" id="numberModal" type="number" name="modelValue" min="0" step="any" required>
                    </div>
