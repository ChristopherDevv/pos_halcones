...
<body>
    ...
    <div class="total">
        <span style="font-weight: bold">Monto recibido:</span> {{$detailDataFormat['amount_received'] ?? 'no aplica'}}
    </div>
    <div class="total">
        <span style="font-weight: bold">Cambio dado:</span> {{$detailDataFormat['amount_change_given'] ?? 'no aplica'}}
    </div>
    <div class="total">
        <span style="font-weight: bold">Tipo de pago:</span> {{$detailDataFormat['payment_type'] ?? 'no aplica'}}
    </div>

    <div class="margin-top-two">
        <table class="signatures" style="margin: 0 auto; width: 50%;">
            <tr>
                <td class="w-half">
                    <hr>
                    <div>{{$managerDataFormat['sender_name']}}</div>
