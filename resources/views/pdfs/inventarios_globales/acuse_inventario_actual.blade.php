...
<body>
    ...
    <table class="w-full">
        <tr>
            <td class="w-half">
                ...
                <h4 style="margin-top: 10px;">Transaccion: Inventario global actual</h4>
            ...
            <td class="w-half">
                <h2>Acuse ID: {{$cashRegisterData['acknowledgment_key']}}</h2>
            </td>
        </tr> 
    </table>
        ...
        <table class="w-full">
            <tr>
                <td class="w-half">
                    ...
                    <div> {{$cashRegisterData['pos_product_warehouse_name']}}</div>
                    <div></div>
                </td>
            </tr>
        </table>
    ...
    <div class="margin-top">
        <h3>Inventario actual en almacen</h3>
        <table class="products">
            ...
            <tr class="items">
                @foreach($globalInventoriesSummary as $item)
                    <tr class="items">
                        <td>
                            {{ $item['name'] }}
                        </td>
    ...
    <div class="margin-top-two">
        <table class="signatures" style="margin: 0 auto; width: 40%;">
            <tr>
                <td class="w-half">
                    <hr>
                    <div>{{$cashRegisterData['manager_name']}}</div>
                </td>
            </tr>
        </table>
    </div>
