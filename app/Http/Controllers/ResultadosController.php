...
class ResultadosController extends Controller
{
   public function index() 
    ...
    public function store(Request $request)
    {
        ...
        $resultado['imgEquipoUno'] = app(\App\Http\Controllers\ImagenesController::class)->upload($resultado['imgEquipoUno']);
        $resultado['imgEquipoDos'] = app(\App\Http\Controllers\ImagenesController::class)->upload($resultado['imgEquipoDos']);
